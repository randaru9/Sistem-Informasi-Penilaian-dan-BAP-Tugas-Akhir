...
Route::get('/resend-otp', [AuthController::class, 'RegenerateOtpLupaKatasandi'])->name('resend-otp');
...
Route::prefix('mahasiswa')->middleware('mahasiswa')->group(function () {
    ...
    Route::prefix('seminar')->group(function () {
        ...
        Route::get('/unduh-draft', [SeminarController::class, 'UnduhDraft'])->name('seminar-unduh-draft');
    });
    ...
    Route::prefix('yudisium')->group(function () {
        ...
        Route::get('/unduh-berkas', [YudisiumController::class, 'UnduhBerkas'])->name('yudisium-unduh-berkas');
    });
...
Route::prefix('admin')->middleware('admin')->group(function () {
    Route::prefix('bap')->group(function () {
        ...
        Route::get('/ubah-rentang-nilai', [BAPController::class, 'UbahRentangNilaiView'])->name('ubah-rentang-nilai');

        Route::post('/ubah-rentang-nilai', [BAPController::class, 'UbahRentangNilai'])->name('ubah-rentang-nilai-post');
        ...
        Route::get('/lihat-bap2', [SeminarController::class, 'Bap2View'])->name('bap-lihat-bap2');

        Route::get('/unduh-bap2', [SeminarController::class, 'UnduhBap2View'])->name('bap-unduh-bap2');
