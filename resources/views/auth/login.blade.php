<x-layout-login title="Login">
    <div class="p-10 w-full xl:w-3/5 space-y-3 flex flex-col justify-center items-center">
        ...
        <form class="w-full space-y-2" action="/lengkapi-data-diri">
            <div>
                <label for="nim_nip" class="block ml-1 text-base text-[#000000] font-poppins font-normal">NIM/NIP</label>
                <input type="text" id="nim_nip" class="bg-gray-50 border rounded-md border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-1.5 w-full " placeholder="abcdef@gmail.com" minlength="9" required />
            </div>
            <div>
                <label for="katasandi" class="block ml-1 text-base text-[#000000] font-poppins font-normal">Kata sandi</label>
                <input type="password" id="katasandi " class="bg-gray-50 border rounded-md border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-1.5 w-full " placeholder="********" minlength="8" required />
            </div>
