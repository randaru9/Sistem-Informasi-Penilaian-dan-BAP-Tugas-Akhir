@php
    $breads = [
        ...
        [
            'href' => '/mahasiswa/profil/ubah-katasandi',
            'title' => 'Ubah Katasandi',
        ],
    ];
@endphp

<x-layout-mahasiswa :$breads title="Ubah Katasandi">
    <div class="bg-white ring-2 ring-blue1 rounded-[10px] w-full h-full overflow-y-auto">
        <form action="{{ route('profil-ubah-katasandi-mahasiswa-post') }}" method="POST">
            @csrf
            ...
            <div class="w-full px-5 flex py-2 gap-2">
                <div class="w-1/2">
                    <label for="katasandi_baru"
                        class="block mb-2 text-sm text-[#000000] font-poppins font-normal">Katasandi baru</label>
            ...
            <div class="w-full px-5 flex py-2 gap-2">
                <div class="w-1/2">
                    <label for="konfirmasi_katasandi"
                        class="block mb-2 text-sm text-[#000000] font-poppins font-normal">Konfirmasi katasandi
                        baru</label>
