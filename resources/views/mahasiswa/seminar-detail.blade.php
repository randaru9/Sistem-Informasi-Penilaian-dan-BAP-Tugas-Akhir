...
<x-layout-mahasiswa :$breads title="Detail Seminar">
    <form action="">
        <div class="bg-white ring-2 ring-blue1 rounded-[10px] w-full h-full overflow-hidden">
            ...
            <div class="w-full px-5 flex py-2 gap-2">
                <div class="w-1/2">
                    <label for="pembimbing1"
                        class="block mb-2 text-base text-[#000000] font-poppins font-normal">Pembimbing
                        1</label>
            ...
            <div class="w-full px-5 flex py-2 gap-2">
                <div class="w-1/2">
                    <label for="tanggal_sidang"
                        class="block mb-2 text-base text-[#000000] font-poppins font-normal">Tanggal Sidang</label>
            ...
            <div class="w-full px-5 flex py-2 gap-2">
                <div class="w-1/2">
                    <label for="status_revisi"
                        class="block mb-2 text-base text-[#000000] font-poppins font-normal">Status Revisi</label>
                ...
                <div class="w-1/2">
                    <label for="status_revisi"
                        class="block mb-2 text-base text-[#000000] font-poppins font-normal">Draft Tugas Akhir</label>
            ...
            <div class="w-full px-5 flex justify-end items-center py-2 gap-2">
                ...
                <a href="/mahasiswa/seminar/cek-revisi"
                    class="bg-gold text-white hover:bg-white hover:ring-2 hover:ring-gold hover:text-gold px-4 py-2 w-fit rounded-[5px] font-poppins text-base">Cek Revisi</a>
            </div>
        </div>
    </form>
</x-layout-mahasiswa>
